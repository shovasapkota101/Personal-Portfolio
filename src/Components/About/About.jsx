...
const About = () => {
  return (
    <div className='text-(--primary-color) overflow-hidden items-center md:flex md:flex-wrap md:justify-center bg-(--background-color) shadow-xl mx-0 md:mx-20 bg-opacity-30 rounded-lg p-12'>
        <div>
